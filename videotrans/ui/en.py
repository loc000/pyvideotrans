...
""")
        ...
        self.actionopenrouterasr_key = QtGui.QAction(MainWindow)
        self.actionopenrouterasr_key.setObjectName("actionopenrouterasr_key")
        ...
        self.menu_RECOGN.addSeparator()
        self.menu_RECOGN.addAction(self.actionopenrouterasr_key)
        self.menu_RECOGN.addSeparator()
    ...
    def _set_Ui_Text(self):
        ...
        self.actionopenrouterasr_key.setText(tr("OpenRouter ASR API"))
